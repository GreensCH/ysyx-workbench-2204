...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 0011011", slliw  , I, R(dest) = src1 << src2);//SEXT(BITS(src1,31,0) << BITS(src2 ,5 ,0), 32));
  INSTPAT("0000000 ????? ????? 101 ????? 0011011", srliw  , I, R(dest) = ((word_t)src1 & 0xFFFF) >> BITS(src2 ,5 ,0));//SEXT(BITS(src1,31,0) >> BITS(src2 ,5 ,0), 32));
