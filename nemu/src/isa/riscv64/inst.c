...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 100 ????? 0010011", xori   , I, R(dest) = src1 ^ SEXT(src2, 12));// src1 ^ SEXT(src2, 12));
  INSTPAT("??????? ????? ????? 110 ????? 0010011", ori    , I, R(dest) = src1 | SEXT(src2, 12));// src1 | SEXT(src2, 12));
  INSTPAT("??????? ????? ????? 111 ????? 0010011", andi   , I, R(dest) = src1 & SEXT(src2, 12));// src1 & SEXT(src2, 12));
