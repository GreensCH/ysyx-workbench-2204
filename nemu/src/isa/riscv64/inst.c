...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, out = (sword_t)src1*(sword_t)src2, R(dest) = out >> 64);
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu , R, out = (sword_t)src1*(word_t )src2, R(dest) = out >> 64);
  INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu  , R, out = (word_t )src1*(word_t )src2, R(dest) = out >> 64);
