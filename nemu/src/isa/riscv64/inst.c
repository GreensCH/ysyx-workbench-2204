...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 0110011", mulh   , R, R(dest) = ((sword_t)src1 * (sword_t)src2) >> 32 );
  INSTPAT("0000001 ????? ????? 010 ????? 0110011", mulhu  , R, R(dest) = ((word_t )src1 * (word_t )src2) >> 32 );
  INSTPAT("0000001 ????? ????? 011 ????? 0110011", mulhsu , R, R(dest) = ((sword_t)src1 * (word_t )src2) >> 32 );
