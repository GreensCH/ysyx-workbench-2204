...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 0110011", mulh   , R, R(dest) = BITS((sword_t)src1 * (sword_t)src2, 63, 32));
  INSTPAT("0000001 ????? ????? 010 ????? 0110011", mulhu  , R, R(dest) = BITS((word_t )src1 * (word_t )src2, 63, 32));
  INSTPAT("0000001 ????? ????? 011 ????? 0110011", mulhsu , R, R(dest) = BITS((sword_t)src1 * (word_t )src2, 63, 32));
  ...
  INSTPAT("0000001 ????? ????? 111 ????? 1111111", remuw  , R, R(dest) = BITS((sword_t)src1 * (word_t )src2, 63, 33));
