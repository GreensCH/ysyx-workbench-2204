...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 0011011", slliw  , I, R(dest) = SEXT(src1 << src2, 32));
  INSTPAT("0000000 ????? ????? 101 ????? 0011011", srliw  , I, R(dest) = SEXT(src1 >> src2, 32));
  INSTPAT("0100000 ????? ????? 101 ????? 0011011", sraiw  , I, R(dest) = SEXT((int32_t)BITS(src1, 31, 0) >> BITS(src2 ,4 ,0), 32));//sraiw  , I, R(dest) = SEXT((sword_t)src1 >> BITS(src2 ,5 ,0), 32));
