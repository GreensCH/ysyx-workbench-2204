...
class Staller extends Module{
  ...
  val eq1 = (addr1 =/= 0.U | addr2 =/= 0.U ) & ((addr1 === ex_dst & ex_dst =/= 0.U) | (addr1 === mem_dst & mem_dst =/= 0.U) | (addr1 === wb_dst & wb_dst =/= 0.U)) //& (optype.Itype | optype.Rtype)
  val eq2 = (addr1 =/= 0.U | addr2 =/= 0.U ) & ((addr2 === ex_dst & ex_dst =/= 0.U) | (addr2 === mem_dst & mem_dst =/= 0.U) | (addr2 === wb_dst & wb_dst =/= 0.U)) //& (optype.Itype | optype.Rtype)
