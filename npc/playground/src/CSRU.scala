...
class CSRU extends Module with CoreParameter with CSRs{
  ...
  /*
   mstatus
   */
  private val mstatus = RegInit("ha00001800".U(64.W))//difftest
  private val vec_mstatus = VecInit(mstatus.asBools())
  ...
  private val vec_mip = VecInit(mip)
