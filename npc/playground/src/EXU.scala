...
//  val id2wb = Mux(stall, 0.U.asTypeOf(new ID2WB), io.in.id2wb)
  ...
  id2wb.wb_sel := io.in.id2wb.wb_sel//io.in.id2wb.wb_sel
  id2wb.regfile_we_addr := io.in.id2wb.regfile_we_addr //io.in.id2wb.regfile_we_addr
  id2wb.regfile_we_en := io.in.id2wb.regfile_we_en//io.in.id2wb.regfile_we_en//
