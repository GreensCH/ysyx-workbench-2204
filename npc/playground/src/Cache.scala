...
class ICache extends Module{
  ...
  val da_0_rdata = Wire(CacheCfg.ram_width.W)
  val da_1_rdata = Wire(CacheCfg.ram_width.W)
  val ta_0_rdata  = Wire(CacheCfg.ram_width.W)
  val ta_1_rdata  = Wire(CacheCfg.ram_width.W)
