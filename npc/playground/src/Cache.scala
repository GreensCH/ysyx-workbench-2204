...
class DCacheUnit extends DCacheBase[DCacheIn, DCacheOut](_in = new DCacheIn, _out = new DCacheOut){
  ...
  */
  ...
  private val test = (Cat(stage1_out.bits.addr(31, 4), 0.U(4.W)) === "h80000450".U) & (stage1_load | stage1_save)
  private val is_writeback = curr_state === sWRITEBACK | next_state === sWRITEBACK
  private val is_1E = stage1_index === "h05".U & (stage1_load | stage1_save)
  dontTouch(test)
